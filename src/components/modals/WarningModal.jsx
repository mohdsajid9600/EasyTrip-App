    ...
    return (
        <div className="fixed inset-0 z-[2000] flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-sm bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-gray-100 dark:border-slate-700 transform transition-all animate-fade-in-up scale-100 opacity-100 text-center p-6">
                ...
                <button
                    onClick={onClose}
                    className="w-full px-5 py-3 rounded-xl font-bold text-white bg-yellow-600 hover:bg-yellow-700 shadow-lg shadow-yellow-500/30 transition-all duration-200 transform hover:-translate-y-0.5"
                >
                    {buttonText}
                </button>
            </div>
